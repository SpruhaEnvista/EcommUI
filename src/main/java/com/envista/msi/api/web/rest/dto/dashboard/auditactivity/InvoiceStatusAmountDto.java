...
@NamedStoredProcedureQueries({
        @NamedStoredProcedureQuery(name = "InvoiceStatusAmountDto.getInvoiceStatusAmount", procedureName = "SHP_DB_INV_STS_AMT_PROC",
                ...
                parameters = {
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardSroredProcParam.InvoiceStatusAmountParams.CURRENCY_ID_PARAM, type = Long.class),
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardSroredProcParam.InvoiceStatusAmountParams.CARRIER_ID_PARAM, type = String.class),
