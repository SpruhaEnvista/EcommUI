...
public class DashboardSroredProcParam {
    public static class NetSpendParams{
        ...
        public static final String SCORE_CARD_PARAM = "p_score_card";
        public static final String SCORE_TYPE_PARAM = "p_score_type";
    }

    public static class TaxSpendParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
        public static final String CARRIER_ID_PARAM = "p_carrier_id";
    ...
    public static class AccessorialSpendParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CONVERTED_CURRENCY_CODE_PARAM = "p_converted_curr_code";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
    ...
    public static class InvoiceStatusAmountParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
        public static final String CARRIER_ID_PARAM = "p_carrier_id";
    ...
    public static class InvoiceMethodScoreParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
        public static final String CARRIER_ID_PARAM = "p_carrier_id";
    ...
    public static class OrderMatchParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
        public static final String CARRIER_ID_PARAM = "p_carrier_id";
    ...
    public static class BilledVsApprovedParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
    ...
    public static class RecoveryAdjustmentParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CONVERTED_CURRENCY_CODE_PARAM = "p_converted_curr_code";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
    ...
    public static class RecoveryServiceParams{
        public static final String DATE_TYPE_PARAM = "p_date_type";
        public static final String CURRENCY_ID_PARAM = "p_currency_id";
        public static final String CONVERTED_CURRENCY_CODE_PARAM = "p_converted_curr_code";
        public static final String CUSTOMER_IDS_CSV_PARAM = "p_customer_ids";
