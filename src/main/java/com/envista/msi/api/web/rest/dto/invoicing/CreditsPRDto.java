...
@NamedStoredProcedureQueries({
        @NamedStoredProcedureQuery(name = "CreditsPRDto.getSearchInfo", procedureName = "SHP_INV_CREDITS_PR_SEARCH_PRO",
                ...
                parameters = {
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = "P_CREATE_DATE_FROM", type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = "P_INVOICE_DATE_FROM", type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = "P_CLOSE_DATE_FROM", type = String.class),
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = "P_CREATE_DATE_TO", type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = "P_INVOICE_DATE_TO", type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = "P_CLOSE_DATE_TO", type = String.class),
