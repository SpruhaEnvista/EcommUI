...
/**
 * The persistent class for the SHP_EBILL_INVOICE_TB database table.
 * 
 */
@Entity
@Table(name="SHP_EBILL_INVOICE_TB")
@NamedQuery(name="ShpEbillInvoiceTb.findAll", query="SELECT s FROM ShpEbillInvoiceTb s")
public class ShpEbillInvoiceTb implements Serializable {
	...
	//bi-directional many-to-one association to ShpEbillManifestTb
	@OneToMany(mappedBy="shpEbillInvoiceTb")
	private List<ShpEbillManifestTb> shpEbillManifestTbs;

	public ShpEbillInvoiceTb() {
	}
	...
	public List<ShpEbillManifestTb> getShpEbillManifestTbs() {
		return this.shpEbillManifestTbs;
	}

	public void setShpEbillManifestTbs(List<ShpEbillManifestTb> shpEbillManifestTbs) {
		this.shpEbillManifestTbs = shpEbillManifestTbs;
	}

	public ShpEbillManifestTb addShpEbillManifestTb(ShpEbillManifestTb shpEbillManifestTb) {
		getShpEbillManifestTbs().add(shpEbillManifestTb);
		shpEbillManifestTb.setShpEbillInvoiceTb(this);

		return shpEbillManifestTb;
	}

	public ShpEbillManifestTb removeShpEbillManifestTb(ShpEbillManifestTb shpEbillManifestTb) {
		getShpEbillManifestTbs().remove(shpEbillManifestTb);
		shpEbillManifestTb.setShpEbillInvoiceTb(null);
