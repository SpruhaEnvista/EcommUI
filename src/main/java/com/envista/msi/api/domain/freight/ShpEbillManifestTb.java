...
/**
 * The persistent class for the SHP_EBILL_MANIFEST_TB database table.
 * 
 */
@Entity
@Table(name="SHP_EBILL_MANIFEST_TB")
@NamedQuery(name="ShpEbillManifestTb.findAll", query="SELECT s FROM ShpEbillManifestTb s")
public class ShpEbillManifestTb implements Serializable {
	...
	@Column(name="EDI_TYPE", length=10)
	...
	//bi-directional many-to-one association to ShpEbillInvoiceTb
	@ManyToOne(fetch=FetchType.LAZY)
	@JoinColumn(name="INVOICE_ID")
	private ShpEbillInvoiceTb shpEbillInvoiceTb;

	public ShpEbillManifestTb() {
	}
	...
	public ShpEbillInvoiceTb getShpEbillInvoiceTb() {
		return this.shpEbillInvoiceTb;
	}

	public void setShpEbillInvoiceTb(ShpEbillInvoiceTb shpEbillInvoiceTb) {
		this.shpEbillInvoiceTb = shpEbillInvoiceTb;
	}
