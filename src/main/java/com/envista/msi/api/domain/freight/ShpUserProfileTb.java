...
public class ShpUserProfileTb implements Serializable {
	...
	@OneToMany(mappedBy="shpUserProfileTb")
	...
	//bi-directional many-to-one association to ShpHomePageTb
	@ManyToOne(fetch=FetchType.LAZY)
	@JoinColumn(name="HOME_PAGE_ID")
	private ShpHomePageTb shpHomePageTb;
	...
	//bi-directional many-to-one association to ShpUserRoleTb
	@OneToMany(mappedBy="shpUserProfileTb")
	...
	public List<ShpAllowedUserCarriersTb> getShpAllowedUserCarriersTbs() {
		return shpAllowedUserCarriersTbs;
	}
	...
	public ShpHomePageTb getShpHomePageTb() {
		return shpHomePageTb;
	}

	public void setShpHomePageTb(ShpHomePageTb shpHomePageTb) {
		this.shpHomePageTb = shpHomePageTb;
	}
