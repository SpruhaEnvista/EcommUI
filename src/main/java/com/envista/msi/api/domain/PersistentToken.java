 ...
 *
 * @see com.envista.msi.api.security.CustomPersistentRememberMeServices
 */
@Entity
...
public class PersistentToken implements Serializable {
    ...
    public ShpUserProfileTb getUser() {
        return user;
    }

    public void setUser(ShpUserProfileTb user) {
        this.user = user;
    }
