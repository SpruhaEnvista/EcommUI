...
@NamedStoredProcedureQueries({
        @NamedStoredProcedureQuery(name = AnnualSummaryDto.Config.StoredProcedureQueryName.ANNUAL_SUMMARY, procedureName = AnnualSummaryDto.Config.StoredProcedureName.ANNUAL_SUMMARY,
                ...
                parameters = {
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.DATE_TYPE_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.CONVERTED_CURRENCY_ID_PARAM, type = Long.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.CONVERTED_CURRENCY_CODE_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.CUSTOMER_IDS_CSV_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.CARRIER_IDS_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.MODES_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.SERVICES_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.LANES_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.FROM_DATE_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.TO_DATE_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.ACCESSORIAL_NAME_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.TOP_TEN_ACCESSORIAL_PARAM, type = Long.class),
                        @StoredProcedureParameter(mode = ParameterMode.REF_CURSOR, name = DashboardStoredProcParam.AnnualSummaryParams.ANNUAL_SUMMARY_DATA_PARAM, type = Void.class)
        }),
        @NamedStoredProcedureQuery(name = AnnualSummaryDto.Config.StoredProcedureQueryName.ANNUAL_SUMMARY_BY_SERVICE, procedureName = AnnualSummaryDto.Config.StoredProcedureName.ANNUAL_SUMMARY_BY_SERVICE,
                ...
                parameters = {
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.ACCESSORIAL_NAME_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.TOP_TEN_ACCESSORIAL_PARAM, type = Long.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.SERVICE_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.REF_CURSOR, name = DashboardStoredProcParam.AnnualSummaryParams.ANNUAL_SUMMARY_DATA_PARAM, type = Void.class)
        }),
        @NamedStoredProcedureQuery(name = AnnualSummaryDto.Config.StoredProcedureQueryName.ANNUAL_SUMMARY_BY_CARRIER, procedureName = AnnualSummaryDto.Config.StoredProcedureName.ANNUAL_SUMMARY_BY_CARRIER,
                ...
                parameters = {
                        ...
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.TOP_TEN_ACCESSORIAL_PARAM, type = Long.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.SERVICE_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.IN, name = DashboardStoredProcParam.AnnualSummaryParams.MODE_NAMES_PARAM, type = String.class),
                        @StoredProcedureParameter(mode = ParameterMode.REF_CURSOR, name = DashboardStoredProcParam.AnnualSummaryParams.ANNUAL_SUMMARY_DATA_PARAM, type = Void.class)
                }),
